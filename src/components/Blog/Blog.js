          ...
          <ul className="flex flex-col divide-y divide-gray-300 ">
            <li className="flex flex-col pt-5 sm:flex-row sm:justify-between">
              ...
              <div className="flex w-full space-x-2 sm:space-x-4">
                ...
                <img className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32 bg-gray-500" src="https://i.ibb.co/F5Jh4bZ/Rectangle-26.png" alt="Polaroid camera" />
            ...
            <li className="flex flex-col sm:flex-row sm:justify-between">
              ...
              <div className="flex w-full space-x-2 sm:space-x-4">
                <img className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32 bg-gray-500" src="https://i.ibb.co/pdPzsgz/Rectangle-27.png" alt="Polaroid camera" />
                <div className="flex flex-col justify-between w-full pb-4">
                  <div className="flex justify-between w-full pb-2 space-x-2">
                    <div className="space-y-1">
                      <h3 className="text-xl font-semibold sm:pr-8">
            ...
            <li className="flex flex-col sm:flex-row sm:justify-between">
              ...
              <div className="flex w-full space-x-2 sm:space-x-4">
                <img className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32 bg-gray-500" src="https://i.ibb.co/r3k3sPD/Rectangle-28.png" alt="Polaroid camera" />
                <div className="flex flex-col justify-between w-full pb-4">
                  <div className="flex justify-between w-full pb-2 space-x-2">
                    <div className="space-y-1">
                      <h3 className="text-xl font-semibold sm:pr-8">
